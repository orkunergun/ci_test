...
#up(){
#	time rclone copy $1 xd:junk -P # apon is my rclone config name, 
#}

tg(){
	bot_api=5367940546:AAHk6roArXbnzqslVYtZ0LVegXUErf__khQ # Your tg bot api, dont use my one haha, it's better to encrypt bot api too.
...
id=1364662838 # Your telegram id
